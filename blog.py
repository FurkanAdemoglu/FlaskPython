...
#     # article["author"]="Furkan Ademoğlu"
#     # return render_template("index.html",number=sayi,article=article)
# # def index():
# #     return "Ana Sayfa"
# # @app.route("/about")
# # def about():
# #     return "Hakkımda"
# # @app.route("/about/Furkan")
# # def furkan():
# #     return "Furkan"
...
def index():
    ...
    return render_template("indexs.html",answer="evet",numbers=numbers,articles=articles)
@app.route("/about")
def about():
    ...
    if request.method=="POST":
        ...
        if result>0:
            ...
            if sha256_crypt.verify(password_entered,real_password):
                ...
                flash("Parolanız veya Kullanıcı Adınızı Yanlış Girdiniz...","danger")
                return redirect(url_for("login"))
        else:
